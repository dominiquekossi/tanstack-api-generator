...
This guide helps you migrate from manual TanStack Query setup to @tanstack-auto/query-api.
...
### After: With @tanstack-auto/query-api
...
Migration to @tanstack-auto/query-api typically:
