# @tanstack-auto/query-api Example

This example demonstrates **all major features** of `@tanstack-auto/query-api` with a comprehensive React application.
...
- [@tanstack-auto/query-api README](../../README.md)
